...
<br>
<h1 style="color:maroon;"><p align="center">Shop Detail&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<h2><a href="product.php" style="text-decoration:none;">View Products</a></h2> </h1></p>
<?php
...
if(!$connection)
	...
	{
		$query="select shopid,shopname,logo from shopinfo";
			...
			while($r=mysqli_fetch_assoc($result))
			{
				...
				$a=$r['shopid'];		
				 ...
				 echo "<table cellspacing='10' cellpadding='10'>";
					...
					echo "<tr><td><img src='shoplogo/$i' width='100' height='100'></td><td><font size='5' face='Monotype Corsiva'><a  style='text-decoration:none;
	color:red;' href='shopinfo.php?id=$a'>".$r['shopname']."</a></font></td></tr>";
					echo "</table>";
				 echo "</td>";
				 $c=$c+1;
