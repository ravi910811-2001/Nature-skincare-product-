...
<tr><td colspan="3" align="center"><h3>Login Page</h3></td></tr>

<tr><td rowspan="3"><img src="pic\aa.jpg" width="300" height="300"></td></tr>

<td>E-mail Id:</td><td><input type="text" name="user" id="user"  /><span id="t1"><span></td></tr>
<tr><td>Password:</td><td><input type="password" name="pass" id="pass" /><span id="t2"><span></td></tr>
<tr><td colspan="3" align="center"><input type="submit" name="signin" id="signin" value="Sign In" />
<input type="reset" name="clear" id="clear" value="Clear" /></td></tr>
<tr><td colspan="3" align="center"><a href="Userregistration.php">New User?</a></td></tr>
</table>
